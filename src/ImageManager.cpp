...
VOID ImageManager::addImage(std::string image_name, ADDRINT lo_addr,
    ADDRINT hi_addr, ADDRINT desired_base)
{
...
VOID ImageManager::addImage(std::string image_name, ADDRINT lo_addr, ADDRINT hi_addr)
{
...
VOID ImageManager::setDesiredBase(const std::string& image_name, ADDRINT desired_base)
{
    PIN_RWMutexWriteLock(&images_lock);
    {
