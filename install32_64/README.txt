...
- TenetTracer32.dll (32-bit build)
- TenetTracer64.dll (64-bit build)
1. Edit the run_me.bat:
- Replace PIN_DIR (default: C:\pin) with your own path to the Pin directory.
- Replace PIN_TOOLS_DIR (default: C:\pin\source\tools\tenet_tracer\install32_64\) with the path to the folder containing this bundle (scripts, tools + other utils).
